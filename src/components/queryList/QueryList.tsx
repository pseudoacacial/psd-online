  ...
  return (
    <div>
      <div className="flex justify-center">
        <button
          className="border hover:bg-bg-1 transition-colors border-main rounded mx-1 px-1 max-w-28 leading-tight"
          onClick={handleImportQueriesFromClipboard}
        >
          import from clipboard
        </button>
        <button
          className="border hover:bg-bg-1 transition-colors border-main rounded mx- px-1 max-w-28 leading-tight"
